...
\begin{enumerate}
    ...
    \begin{enumerate}
      \item We believe a particular measurement is approximately normally distributed. However, we are only able to measure accuracy up to integer values. Thus, we observe 3 partial values: $1 \leq x^*_1 < 2$, $3 \leq x_2^{*} < 4$, and $6 \leq x_3^* < 7$. Find an expression of the likelihood function under this model.
    \end{enumerate}
\end{enumerate}
