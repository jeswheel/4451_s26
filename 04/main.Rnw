...
png("figures/beta_prior_plot.png", width = 800, height = 600)
x <- seq(1e-6, 1-1e-6, length.out = 1000)
y <- dbeta(x, 7, 21)
plot(x, y, type = 'l', xlab = 'Batting percentage', ylab = "prior")
dev.off()
@

<<echo=FALSE,include=FALSE>>=
png("figures/baseballPost.png", width = 800, height = 600)
