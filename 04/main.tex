  ...
  \begin{exampleblock}{Conjugate Normals}
    ...
    \mode<article>{
      \begin{proof}
        ...
        TODO: There are errors after this part, signs are flipped in the second part of the exponential.
        ...
        & = -\frac{1}{2}\Big(\frac{n\sigma^2 - \sigma^2_0}{2\sigma^2\sigma_0^2}\Big)\mu^2 \\
        &= -\frac{1}{2}a\mu^2
        \end{align*}
        ...
        \begin{align*}
          b/a &= \Big(\frac{n\bar{x}^*\sigma_0^2 - \mu_0\sigma^2}{\sigma^2\sigma_0^2}\Big)/\Big(\frac{n\sigma^2 - \sigma^2_0}{2\sigma^2\sigma_0^2}\Big) \\
          &= \frac{n\bar{x}^*\sigma_0^2 - \mu_0\sigma^2}{n\sigma^2 - \sigma^2_0}
        \end{align*}
      \end{proof}
    }
...
\begin{frame}[allowframebreaks,fragile]{Variance reduction techniques}
  ...
  \begin{block}{Antithetic Variates Method}
   ...
   Suppose we want to compute an integral $\int_0^1 f(x) dx$.
    ...
    TODO: There's a sign-error in the $\mu$ term. They should both be the same sign!
