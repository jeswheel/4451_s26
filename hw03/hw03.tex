...
\begin{enumerate}
  ...
  Your task is to predict $Y_i = \texttt{am}$, a binary variable in the data indicating whether or not the car is an automatic (0) or manual (1) based on other car features, $X_i$.
